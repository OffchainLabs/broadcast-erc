...
interface IERC7786GatewaySource {
     ...
     */
    event MessagePosted( // CAIP-10 account identifier (chain identifier + ":" + account address)
        // CAIP-10 account identifier (chain identifier + ":" + account address)
    bytes32 indexed outboxId, string sender, string receiver, bytes payload, bytes[] attributes);
